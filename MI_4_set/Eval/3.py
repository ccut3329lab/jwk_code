...
from Load_Dataset.patient1 import Train_Data, Test_Data, sig_train, sig_test, label_train, label_test
from Models.Test_model import AMCNN_patient1_trails

train_set = Train_Data(sig_train, label_train)
test_set = Test_Data(sig_test, label_test)
train_loader = DataLoader(dataset=train_set, batch_size=230, shuffle=True, drop_last=True)
test_loader = DataLoader(dataset=test_set, batch_size=58, shuffle=False, drop_last=True)
...
# tsne = TSNE(n_components=2, perplexity=20, early_exaggeration=2.0, learning_rate=1000)   # perplexity=40, learning_rate=600,batch_size=128
tsne = TSNE(n_components=2, perplexity=30, early_exaggeration=2.0, learning_rate=600)   # perplexity=40, learning_rate=600,batch_size=128
